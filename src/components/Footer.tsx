...
export function Footer() {
  return (
    <footer 
      className="bg-black text-white pt-40 md:pt-64 pb-8 px-4 md:px-8 relative min-h-[100svh] md:min-h-0 flex flex-col justify-end"
    ...
    >
      ...
      <div className="mt-auto md:mt-12 w-full relative flex justify-center items-end">
        ...
        <h1 className="text-[25vw] md:text-[22vw] font-bold tracking-tighter leading-none text-center relative z-10 w-full">
          Alice<span className="text-[8vw] md:text-[6vw] align-top relative -top-[2vw]">®</span>
        </h1>
      </div>
